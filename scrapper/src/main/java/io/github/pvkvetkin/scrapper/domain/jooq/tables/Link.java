...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, String> LINK_TYPE = createField(DSL.name("LINK_TYPE"), SQLDataType.VARCHAR(1000000000), this, "");
    ...
    public List<Check<LinkRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("CONSTRAINT_23A"), "\"LINK_TYPE\" IN('GITHUB', 'STACKOVERFLOW')", true)
        );
    }
